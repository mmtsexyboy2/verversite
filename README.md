...
8.  اگر همه چیز به درستی کار کند، باید به صفحه تاپیک جدید هدایت شوید.
    *   **در صفحه تاپیک، باید جزئیات کامل تاپیک (عنوان، متن، نویسنده، تاریخ) را مشاهده کنید.**
    *   **باید بتوانید تاپیک را لایک کنید.**
    *   **باید بتوانید برای تاپیک کامنت ارسال کنید، به کامنت‌ها پاسخ دهید (به صورت ساده)، و کامنت‌ها را لایک یا حذف کنید (اگر مالک کامنت یا ادمین باشید).**
